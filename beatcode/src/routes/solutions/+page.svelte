			...
			<div class="px-4 py-8 lg:w-1/3">
				<div class="flex h-full items-start">
					<div class="flex w-12 flex-shrink-0 flex-col text-center leading-none">
						<span class="mb-2 border-b-2 border-gray-200 pb-2 text-gray-500">Jul</span>
						<span class="title-font text-lg font-medium leading-none text-gray-800">18</span>
					</div>
					<div class="flex-grow pl-6">
						<h2 class="title-font mb-1 text-xs font-medium tracking-widest text-indigo-500">
							CATEGORY
						</h2>
						<h1 class="title-font mb-3 text-xl font-medium text-gray-900">The 400 Blows</h1>
						...
						<a class="inline-flex items-center">
							...
							/>
							<span class="flex flex-grow flex-col pl-3">
			...
			<div class="px-4 py-8 lg:w-1/3">
				<div class="flex h-full items-start">
					...
					<div class="flex-grow pl-6">
						...
						<h1 class="title-font mb-3 text-xl font-medium text-gray-900">Shooting Stars</h1>
						<p class="mb-5 leading-relaxed">
							Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled
							waistcoat.
						</p>
			...
			<div class="px-4 py-8 lg:w-1/3">
				<div class="flex h-full items-start">
					...
					<div class="flex-grow pl-6">
						...
						<h1 class="title-font mb-3 text-xl font-medium text-gray-900">Neptune</h1>
						<p class="mb-5 leading-relaxed">
							Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled
							waistcoat.
						</p>
